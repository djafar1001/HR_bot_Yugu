...
BOT_MESSAGE = {
    ...
    2: {
        ...
        2: 'В рамках программы адаптации тебе необходимо изучить\n '
           'ценности Банка России на корпоративном портале',
        3: 'Далее необходимо изучить <b>стратегические цели Банка России\n '
           'и Карту Целей руководителя.</b>\n'
...
QUEST_SECOND_LIST =['Тебе было удобно работать с чат ботом?',
                    'Материалы Банка России были понятны и доступны',
                    'Оцени собственный прогресс в достижении цели «Получение знаний о Банке России»'
                    ]